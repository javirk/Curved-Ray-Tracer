...
class Material:
    ...
    def scatter_lambertian(self, r_in, normal):
        scatter_direction = random_on_unit_sphere_like(r_in.vel) #+ r_in.vel # This is actually a velocity
        scatter_pos = r_in.pos + normal * 0.01 # Normal goes outward, this is to prevent the next step to hit the sphere again
    ...
    def scatter_metal(self, r_in, normal):
        ...
        scatter_pos = r_in.pos + normal * 0.01
